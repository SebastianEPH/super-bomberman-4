...
y1 = y+16;
	...
	switch (global.typeBomb){
		...
		case 1:		// Create instancia "Bomba Pierce"
			var bomb = instance_create_depth(x1,y1,"bomb",obj_bombPierce);
		break;
		case 2:		// Create instancia "Remote Bomb"
			var bomb = instance_create_depth(x1,y1,"bomb",obj_bombRemote);
		break;
		case 3:		// Create instancia "Bomb - S"
			var bomb = instance_create_depth(x1,y1,"bomb",obj_bombS);
		break;
		case 4:		// Create instancia "Bomb - H"
			var bomb = instance_create_depth(x1,y1,"bomb",obj_bombH);
		break;
		case 5:		// Create instancia "Bomb - D"
			var bomb = instance_create_depth(x1,y1,"bomb",obj_bombD);
		break;
		default : 
			var bomb = instance_create_depth(x1,y1,"bomb",obj_bomb);
	}
